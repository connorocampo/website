...
export default () => (
  <ThemeProvider theme={themeSettings}>
    <Layout>
      ...
      <CallToAction>
        Currently, I'm looking for job opportunities utilizing skills I already have and/or learning new things. If you think I'd be a good match to your company mission and culture, <a href="https://connorocampo.github.io/connorocampo/contact/" target="_blank" rel="noopener noreferrer">let's chat</a>!
      </CallToAction>
      <br />
      <h2>Tech I've Worked With</h2>
      <p>
        <b><u>Front-end:</u></b> Github, Atom, VS Code (my fav), GIT, Homebrew, CSS, SCSS, Bootstrap, Flexbox, Tailwind, React, styled-components, Gatsby, GraphQL, Netlify, Surge.sh. The design aspect is in my wheelhouse in terms of front-end development.
      </p>
      <p>
        <b><u>Video/Graphics:</u></b> Sketch, Abstract, Photoshop, good ol' sketch paper, DaVinci Resolve.
      </p>
      <LastParagraph>
