...
export default () => (
  <ThemeProvider theme={themeSettings}>
    <Container>
      ...
      <Text>
        <Subheading>Privacy Policy for ConnorOcampo.com</Subheading>
        At connorocampo.com, we recognize that privacy of your personal information is important. Here is information on what types of personal information we receive and collect when you use and visit connorocampo.com, and how we safeguard your information. We never sell your personal information to third parties.

        <Subheading>Who we are</Subheading>
        Our website address is: https://connorocampo.com.  This site is owned an operated by Connor Ocampo, a sole proprietor in the state of Florida in the United States.  He can be reached at connorocampo@gmail.com.
        ...
        When you fill out a contact form on connorocampo.com we only collect the information you enter into the contact form.  If the form asks for your name, email address, or any other personal information, then that information is sent to us via email.  We only retain that information—including your email address—for as long as necessary to address your purpose in contacting us.

        Email addresses provided in contact forms are not ever used by connorocampo.com for any purpose other than to reply to you in regards to your reason for contacting us.  We never sell information from contact forms to any third parties for any purpose.
        ...
        We use third party advertisements on connorocampo.com to support our site. Some of these advertisers may use technology such as cookies and web beacons when they advertise on our site, which will also send these advertisers (such as Google through the Google AdSense program) information including your IP address, your ISP , the browser you used to visit our site, and in some cases, whether you have Flash installed. This is generally used for geotargeting purposes (showing New York real estate ads to someone in New York, for example) or showing certain ads based on specific sites visited (such as showing cooking ads to someone who frequents cooking sites).
